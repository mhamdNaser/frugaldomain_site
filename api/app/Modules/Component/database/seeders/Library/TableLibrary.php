    ...
    private static function setOne(): array
    {
        return [
            [
                ...
                'tagline_ar' => 'قائمة أشخاص قابلة للبحث مع الأدوار وشارات الحالة وإجراءات الصفوف.',
                ...
                'summary_ar' => 'قائمة الإدارة اليومية: صور رمزية مرسومة من الأحرف الأولى، وعمود للدور، وشارة للحالة، وإجراءات تظهر عند التمرير فوق الصف فيبقى هادئًا حتى تحتاج إليه. ويصفّي البحث الصفوف أثناء الكتابة.',
                'accent' => '#2563eb',
                ...
                'features_ar' => ['بحث فوري في الاسم والبريد الإلكتروني والدور', 'صور رمزية من الأحرف الأولى، بلا أي طلبات للصور', 'إجراءات الصف تظهر عند التمرير فوقه وعند التركيز'],
                'height' => 520,
                'max' => 900,
                'css' => self::hoverCss(),
            ...
            [
                ...
                'tagline_ar' => 'انقر أي ترويسة للفرز تصاعديًا أو تنازليًا، مع مراعاة القيم الرقمية.',
                ...
                'summary_ar' => 'فرز في نحو عشرين سطرًا من JavaScript خالص. تُكتشف الأعمدة الرقمية وتُقارن كأرقام لا كنصوص، فلا يأتي 9 بعد 10 أبدًا، وتحمل الترويسة النشطة سهمًا يوضّح الترتيب الحالي.',
                'accent' => '#0891b2',
                ...
                'features_ar' => ['فرز بثلاث حالات على كل عمود', 'مقارنة الأعمدة الرقمية كأرقام', 'اتجاه الفرز ظاهر في الترويسة'],
                'height' => 500,
                'max' => 820,
            ...
            [
                ...
                'tagline_ar' => 'أموال داخلة وأموال خارجة، بمبالغ موقّعة وحالة تسوية.',
                ...
                'summary_ar' => 'يُقرأ دفتر الحركات على أفضل وجه حين يُميَّز الدائن من المدين باللون والإشارة لا بعمود مستقل. وتغطي الحالات الثلاث المهمة تشغيليًا: مُسوّاة، ومعلّقة، وفاشلة.',
                'accent' => '#059669',
                ...
                'features_ar' => ['مبالغ موقّعة وملوّنة حسب نوعها', 'حالة التسوية لكل صف', 'رصيد جارٍ في التذييل'],
                'height' => 500,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'بنود الفوترة مع الكمية والسعر وكتلة للإجماليات.',
                ...
                'summary_ar' => 'النصف من الفاتورة الذي يجب أن يكون صحيحًا حقًا: البنود، ثم كتلة إجماليات تفصل المجموع الفرعي والخصم والضريبة والمبلغ المستحق. والمبلغ المستحق وحده يأتي باللون المميز، فتقع عليه العين أولًا.',
                'accent' => '#4f46e5',
                ...
                'features_ar' => ['الكمية والسعر وإجمالي البند في كل صف', 'كتلة إجماليات تشمل الضريبة والخصم', 'مناسب للطباعة، بلا JavaScript إطلاقًا'],
                'height' => 560,
                'max' => 780,
            ...
            [
                ...
                'tagline_ar' => 'مسار الطلبات مع حالة التنفيذ وشريط تصفية.',
                ...
                'summary_ar' => 'قائمة طلبات مبنية حول مرشّح الحالة: الشارات فوق الجدول هي أداة التحكم الأساسية، والعدد بجانب كل منها يغنيك عن التصفية لمجرد معرفة إن كان هناك شيء أصلًا.',
                'accent' => '#d97706',
                ...
                'features_ar' => ['شارات تصفية بأعداد محدّثة فوريًا', 'حالة التنفيذ لكل طلب', 'تصفية بلا أي اعتماديات'],
                'height' => 560,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'المخزون المتوفر مع شريط للمستوى وتنبيه لإعادة الطلب.',
                ...
                'summary_ar' => 'المخزون كمية وحدّ أدنى، لذا يحمل كل صف الاثنين: مقياس يُظهر امتلاء الموقع مقارنةً بنقطة إعادة الطلب، وشارة تتحول إلى الكهرماني لحظة النزول تحتها. وتكفي نظرة واحدة لقراءة الجدول كله.',
                'accent' => '#0d9488',
                ...
                'features_ar' => ['مقياس للمخزون مقارنةً بنقطة إعادة الطلب', 'شارات لانخفاض المخزون ونفاده', 'SKU وموقع التخزين لكل صف'],
                'height' => 540,
                'max' => 900,
                'css' => "tbody tr:hover{background:var(--soft)}\n.lvl{min-width:130px}",
                'body' => self::wrap(
            ...
            [
                ...
                'tagline_ar' => 'ترتيب المتسابقين مع الميداليات والتحرك والنقاط.',
                ...
                'summary_ar' => 'على جدول المتصدرين أن يجيب عن سؤالين بنظرة واحدة: من في القمة، ومن يصعد. تحصل المراكز الثلاثة الأولى على أقراص ميداليات، ويحمل كل صف تحركه منذ الفترة السابقة كفارق موقّع وملوّن.',
                'accent' => '#f59e0b',
                ...
                'features_ar' => ['ميداليات للمراكز الثلاثة الأولى', 'عمود للتحرك بإشارة موجبة أو سالبة', 'شريط نقاط نسبةً إلى المتصدر'],
                'height' => 540,
                'max' => 780,
            ...
            [
                ...
                'tagline_ar' => 'مصفوفة ميزات الباقات مع عمود مُوصى به ومميّز.',
                ...
                'summary_ar' => 'ثلاث باقات أفقيًا، والميزات عموديًا، وبينها علامات صح وشُرَط. العمود المُوصى به ملوّن من أعلاه إلى أسفله لا بمجرد شارة، فتتبعه العين نزولًا دون الرجوع إلى الترويسة.',
                'accent' => '#7c3aed',
                ...
                'features_ar' => ['عمود مُوصى به ملوّن من الأعلى إلى الأسفل', 'علامات صح وشُرَط بدل نص «نعم/لا»', 'دعوة إلى الإجراء لكل باقة في صف التذييل'],
                'height' => 620,
                'max' => 820,
            ...
            [
                ...
                'tagline_ar' => 'الاشتراكات النشطة ومواعيد التجديد والإيراد الشهري المتكرر لكل عميل.',
                ...
                'summary_ar' => 'مصمَّم للسؤال الذي تُفتح لأجله شاشة الفوترة عادةً: ما الذي يتجدد تاليًا، وكم قيمته؟ تحمل مواعيد التجديد وصفًا نسبيًا، ويُبرَز كل ما يتجدد خلال أسبوع.',
                'accent' => '#2563eb',
                ...
                'features_ar' => ['مواعيد تجديد نسبية مع تنبيه لما يقترب', 'الباقة وعدد المقاعد لكل عميل', 'إجمالي MRR في التذييل'],
                'height' => 520,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'طابور تذاكر بأشرطة أولوية وعدّاد تنازلي لـ SLA.',
                ...
                'summary_ar' => 'طابور يُفرز بالنظر: شريط ملوّن على يسار كل صف يحمل الأولوية، وعمود SLA يعدّ تنازليًا ويتحول إلى الأحمر حين تتجاوز التذكرة المهلة. ويظهر المكلَّفون كصور رمزية فيتضح توزيع العمل.',
                'accent' => '#e11d48',
                ...
                'features_ar' => ['شريط أولوية على كل صف', 'عدّاد SLA تنازلي يتحول إلى «متجاوز»', 'صور رمزية للمكلَّفين مع حالة «غير مُسنَد»'],
                'height' => 540,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'مربعات اختيار للصفوف، وتحديد الكل في الترويسة، وشريط إجراءات جماعية.',
                ...
                'summary_ar' => 'تحديد متقن: يعكس مربع الاختيار في الترويسة التحديد الجزئي بالحالة غير المحددة، ولا يظهر الشريط الجماعي إلا عند تحديد شيء، فلا يشغل مساحة لم يستحقها.',
                'accent' => '#4f46e5',
                ...
                'features_ar' => ['مربع «تحديد الكل» بحالة غير محددة', 'شريط جماعي يظهر مع أول تحديد', 'تلوين الصفوف المحددة للتأكيد'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'انقر صفًا لتكشف لوحة تفاصيله أسفله.',
                ...
                'summary_ar' => 'تفاصيل بلا انتقال: يفتح السهم لوحة في الصف التالي، فتُفحص الشحنة أو الطلب أو عملية النشر دون مغادرة القائمة. مبني على صف جدول مخفي، فتبقى الأعمدة متحاذية.',
                'accent' => '#0891b2',
                ...
                'features_ar' => ['لوحة التفاصيل داخل الجدول لا في نافذة حوارية', 'سهم يدور ليُظهر حالة الفتح', 'يمكن الوصول إليه بلوحة المفاتيح، فالمشغّل زر'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'أكبر عدد من الصفوف في الشاشة، للمشغّلين لا للتصفح.',
                ...
                'summary_ar' => 'شبكة كثيفة عن قصد: ارتفاع صفوف محدود، وأرقام أحادية المسافة، وفواصل رفيعة، وترويسة ثابتة. هذا هو الجدول الذي تريده حين يمسح أحدهم مئتي صف في الدقيقة، وهو نقيض جدول التسويق الفسيح.',
                'accent' => '#334155',
                ...
                'features_ar' => ['ارتفاع صف 28px مع ترويسة ثابتة', 'أرقام جدولية في كل مكان', 'منطقة تمرير مع ترويسة مثبتة'],
                'height' => 520,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'مخططات اتجاه لكل صف بجانب الإجماليات.',
                ...
                'summary_ar' => 'الأرقام تقول أين أنت، والرسم المصغر يقول كيف وصلت. يحمل كل صف اتجاه أربعة عشر يومًا مرسومًا بـ SVG مضمّن، فلا مكتبة مخططات، ويبقى الملف نظيفًا عند الطباعة.',
                'accent' => '#2563eb',
                ...
                'features_ar' => ['رسم مصغر بـ SVG مضمّن لكل صف', 'تغيّر موقّع مقارنةً بالفترة السابقة', 'الحصة من الإجمالي كمقياس'],
                'height' => 520,
                'max' => 920,
            ...
            [
                ...
                'tagline_ar' => 'من فعل ماذا، وبأي سجل، ومن أين.',
                ...
                'summary_ar' => 'لا يفيد سجل التدقيق إلا إذا أجاب كل سطر عن الفاعل والإجراء والهدف والمصدر دون فتحه. تُلوَّن الإجراءات حسب نوعها: إنشاء، وتحديث، وحذف، ويأتي عنوان IP ووكيل المستخدم في السطر الثانوي.',
                'accent' => '#475569',
                ...
                'features_ar' => ['أفعال الإجراءات ملوّنة حسب نوعها', 'الفاعل والهدف والمصدر في كل سطر', 'معرّفات سجلات أحادية المسافة لسهولة المسح'],
                'height' => 540,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'أسرار مُقنّعة مع إظهار ونسخ وآخر استخدام.',
                ...
                'summary_ar' => 'المفاتيح مُقنّعة افتراضيًا وتُكشف واحدًا تلو الآخر، لأن لوحة تحكم مليئة بأسرار حية أثناء مشاركة الشاشة هي الطريقة الكلاسيكية لتسرّبها. ويكتب النسخ إلى الحافظة ويؤكد في مكانه.',
                'accent' => '#0f766e',
                ...
                'features_ar' => ['مفاتيح مُقنّعة مع إظهار لكل صف', 'نسخ إلى الحافظة مع تأكيد مباشر', 'شارات النطاق وتوقيت آخر استخدام'],
                'height' => 520,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'صحة الخوادم مع مقاييس المعالج والذاكرة ومدة التشغيل.',
                ...
                'summary_ar' => 'صف لكل عقدة، يحمل الأرقام الثلاثة التي ينظر إليها المهندس المناوب فعلًا، مرسومة كمقاييس تتحول إلى الكهرماني ثم الأحمر عند الحدود بدل ترك نسبة مئوية تحتاج إلى تفسير.',
                'accent' => '#16a34a',
                ...
                'features_ar' => ['مقاييس CPU والذاكرة بألوان الحدود', 'المنطقة ومدة التشغيل لكل عقدة', 'شارة صحة يحددها أسوأ مؤشر'],
                'height' => 540,
                'max' => 940,
                'theme' => 'dark',
                'categories' => ['dashboards'],
            ...
            [
                ...
                'tagline_ar' => 'قائمة مهام مع المكلَّف وتاريخ الاستحقاق والتقدم.',
                ...
                'summary_ar' => 'عرض القائمة في أداة إدارة المشاريع: مربع اختيار يشطب الصف، وتاريخ استحقاق يتحول إلى الأحمر بعد فواته، ومقياس للتقدم، ومكلَّف. ما يكفي لإدارة مشروع صغير دون مغادرة الجدول.',
                'accent' => '#7c3aed',
                ...
                'features_ar' => ['مربع اختيار يُنجز الصف في مكانه', 'التواريخ المتأخرة مُبرَزة بالأحمر', 'مقياس تقدم لكل مهمة'],
                'height' => 540,
                'max' => 900,
    ...
    private static function setTwo(): array
    {
        return [
            [
                ...
                'tagline_ar' => 'أسعار حية وتغيّر 24 ساعة والقيمة السوقية على لوحة داكنة.',
                ...
                'summary_ar' => 'تُقرأ لوحة السوق على أفضل وجه داكنةً: الأخضر والأحمر يحملان التغيّر، والرسم المصغر يحمل شكل اليوم، ولا شيء آخر ينافس على الانتباه. وتستخدم الأسعار أرقامًا جدولية فتبقى الأعمدة ثابتة مع كل تحديث.',
                'accent' => '#f59e0b',
                ...
                'features_ar' => ['لوحة داكنة بأعمدة تغيّر حمراء وخضراء', 'رسم مصغر لـ 24 ساعة لكل أصل', 'القيمة السوقية وحجم التداول بأرقام جدولية'],
                'height' => 540,
                'max' => 940,
                'theme' => 'dark',
            ...
            [
                ...
                'tagline_ar' => 'صفوف قائمة المتابعة مع سعر الطلب والعرض والفارق ونطاق اليوم.',
                ...
                'summary_ar' => 'قائمة متابعة مبنية حول شريط نطاق اليوم: يُظهر المؤشر موقع آخر صفقة بين الأدنى والأعلى، وهو الشيء الوحيد الذي لا يخبرك به عمود سعر عادي.',
                'accent' => '#0891b2',
                ...
                'features_ar' => ['شريط نطاق اليوم مع تحديد آخر سعر', 'أعمدة سعر الطلب والعرض والفارق', 'تغيّر موقّع بالقيمة والنسبة المئوية معًا'],
                'height' => 520,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'قائمة الموظفين مجمّعة حسب القسم مع اختصارات للتواصل.',
                ...
                'summary_ar' => 'دليل يستخدمه الناس فعلًا للوصول إلى أحدهم: ترويسات مجموعات للأقسام، والمسمى الوظيفي تحت كل اسم، وزرّا البريد والهاتف في نهاية الصف بدل صفحة تفاصيل تبعد نقرتين.',
                'accent' => '#0f766e',
                ...
                'features_ar' => ['صفوف مجمّعة تحت ترويسات الأقسام', 'اختصارات للبريد والاتصال لكل شخص', 'مدة الخدمة والموقع في السطر الثانوي'],
                'height' => 560,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'المجلدات أولًا ثم الملفات، مع مسار تنقّل.',
                ...
                'summary_ar' => 'نصف القائمة في مدير الملفات: مسار تنقّل يُظهر موقعك، ومجلدات مرتبة فوق الملفات كما يفعل كل متصفح ملفات، ومربعات أنواع ملوّنة لتجد العين ملف PDF دون قراءة الامتداد.',
                'accent' => '#2563eb',
                ...
                'features_ar' => ['مسار تنقّل فوق القائمة', 'المجلدات مرتبة قبل الملفات', 'مربعات أنواع ملوّنة حسب النوع'],
                'height' => 560,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'الإرسال والفتح والنقر كنسب لا كأعداد خام.',
                ...
                'summary_ar' => 'تقارير حملات تكون النسب فيها هي الأساس: يُرسم الفتح والنقر كمقاييس مقارنةً بمتوسط القائمة، فتتضح الحملة ضعيفة الأداء دون حسابات ذهنية.',
                'accent' => '#db2777',
                ...
                'features_ar' => ['نسب الفتح والنقر مرسومة كمقاييس', 'حالة التسليم لكل حملة', 'حجم الإرسال وإلغاءات الاشتراك'],
                'height' => 540,
                'max' => 940,
                'categories' => ['dashboards'],
            ...
            [
                ...
                'tagline_ar' => 'الترتيب والتحرك وحجم البحث والرابط المتصدر.',
                ...
                'summary_ar' => 'تتبّع الترتيب في صف واحد: الترتيب الحالي كقرص ملوّن حسب الصفحة الأولى أو الثانية أو ما بعدها، والتحرك منذ الأسبوع الماضي، والرابط الذي يتصدر فعلًا، وهو العمود الذي يخبرك إن كانت الصفحة الصحيحة هي الفائزة.',
                'accent' => '#16a34a',
                ...
                'features_ar' => ['قرص الترتيب ملوّن حسب صفحة نتائج البحث', 'التحرك الأسبوعي مع اتجاهه', 'الرابط المتصدر وحجم البحث'],
                'height' => 540,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'مشكلات مع الخطورة والتصنيفات والمُبلّغ والعمر.',
                ...
                'summary_ar' => 'قائمة مشكلات تحمل فرزها بنفسها: الخطورة كحدّ أيسر، والتصنيفات كشارات، وعمود للعمر يُحرج بهدوء كل ما بقي مفتوحًا طويلًا. والمعرّف أحادي المسافة ليسهل نسخه في رسالة commit.',
                'accent' => '#dc2626',
                ...
                'features_ar' => ['الخطورة معروضة كحدّ للصف', 'شارات تصنيف لكل مشكلة', 'عمود للعمر يُبرز المشكلات الراكدة'],
                'height' => 540,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'كل شحنة مع مسار تقدم مضمّن من الاستلام حتى التسليم.',
                ...
                'summary_ar' => 'يحمل كل صف الرحلة كاملة كمسار من أربع محطات، فيُجاب عن السؤال الذي تُفتح لأجله شاشة التتبع، أي إلى أين وصلت الشحنة، دون فتح أي شيء. وتتحول مسارات الشحنات المتأخرة إلى الأحمر.',
                'accent' => '#7c3aed',
                ...
                'features_ar' => ['مسار تقدم من أربع محطات داخل كل صف', 'الشحنات المتأخرة مُعلَّمة على المسار نفسه', 'شركة الشحن وموعد الوصول المتوقع ورقم التتبع'],
                'height' => 560,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'علامات كل تقييم مع درجة نهائية موزونة.',
                ...
                'summary_ar' => 'يُقرأ صف سجل الدرجات من البداية إلى النهاية كما مضى الفصل الدراسي، وينتهي بتقدير حرفي على قرص ملوّن. والعمل المفقود شَرطة لا صفر، لأن الاثنين يعنيان للمعلم أمرين مختلفين تمامًا.',
                'accent' => '#4f46e5',
                ...
                'features_ar' => ['أعمدة التقييمات مع أوزانها في الترويسة', 'قرص التقدير الحرفي ملوّن حسب الفئة', 'تمييز العمل المفقود عن الصفر'],
                'height' => 540,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'شهر من الحضور كشبكة نقاط لكل شخص.',
                ...
                'summary_ar' => 'ثلاثون خلية في الصف، كل منها نقطة ملوّنة: حاضر، أو عن بُعد، أو غائب، أو إجازة. يتسع حضور فريق كامل لشهر في شاشة واحدة، ويظهر النمط، كغياب كل يوم اثنين مثلًا، بطريقة لا تتيحها قائمة تواريخ أبدًا.',
                'accent' => '#0d9488',
                ...
                'features_ar' => ['نقطة لكل يوم مع مفتاح بأربع حالات', 'الشهر كاملًا في شاشة واحدة', 'عمود إجماليات لكل شخص'],
                'height' => 520,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'مطالبات مع الإيصالات وحالة الاعتماد واعتماد مباشر.',
                ...
                'summary_ar' => 'طابور للمعتمِد: الإيصال رابط لا مرفق تبحث عنه، وزرّا الاعتماد والرفض داخل الصف، فتُنجز دفعة من المطالبات الصغيرة دون فتح أي منها.',
                'accent' => '#059669',
                ...
                'features_ar' => ['زرّا الاعتماد والرفض داخل الصف', 'روابط الإيصالات مع عدد الصفحات', 'تعليم مخالفة السياسة على المبلغ'],
                'height' => 540,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'الإجمالي والاستقطاعات وصافي الأجر مع ملخص للمسير.',
                ...
                'summary_ar' => 'مسير رواتب يُراجع قبل اعتماده: الإجمالي أولًا، والاستقطاعات مفصّلة لا مجمّعة، والصافي بخط عريض في النهاية. ويجمع التذييل المسير كله فلا يُعاد حساب مبلغ التحويل يدويًا أبدًا.',
                'accent' => '#1d4ed8',
                ...
                'features_ar' => ['استقطاعات مفصّلة لكل موظف', 'إبراز صافي الأجر على الإجمالي', 'إجماليات المسير في التذييل'],
                'height' => 540,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'حجوزات مع تواريخ الإقامة ونوع الغرفة والرصيد.',
                ...
                'summary_ar' => 'قائمة مكتب الاستقبال: الوصول والمغادرة مع عدد الليالي بينهما، والغرفة والسعر، وما زال مستحقًا. ويُبرَز الواصلون اليوم بصف ملوّن بدل شاشة منفصلة.',
                'accent' => '#b45309',
                ...
                'features_ar' => ['تواريخ الإقامة مع حساب عدد الليالي', 'إبراز الواصلين اليوم في مكانهم', 'الرصيد المستحق لكل حجز'],
                'height' => 540,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'لوحة المغادرة مع البوابة والحالة والتأخير.',
                ...
                'summary_ar' => 'لوحة المطار منقولة إلى الويب: الموعد المجدول مشطوب حين يتغير، والموعد المعدّل بجانبه، والحالة باللون الذي تستخدمه شاشات الصالات. داكنة افتراضيًا، كما تُقرأ هذه اللوحات دائمًا.',
                'accent' => '#0ea5e9',
                ...
                'features_ar' => ['المواعيد المعدّلة معروضة مقابل المجدولة', 'ألوان الحالة وفق أعراف المطارات', 'عمودا البوابة والصالة'],
                'height' => 520,
                'max' => 940,
                'theme' => 'dark',
            ...
            [
                ...
                'tagline_ar' => 'أطباق مع العلامات الغذائية والسعرات والسعر.',
                ...
                'summary_ar' => 'قائمة الطعام كجدول، وهذا ما يحتاجه المطبخ أو المكتب الخلفي فعلًا: علامات مسببات الحساسية والأنظمة الغذائية كشارات، والسعرات بجانب السعر، وتوفر يمكن إيقافه للمساء دون حذف الطبق.',
                'accent' => '#c2410c',
                ...
                'features_ar' => ['شارات غذائية ومسببات حساسية لكل طبق', 'مفتاح تبديل للتوفر في كل صف', 'ترويسات مجموعات حسب الوجبة'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'عقارات مع صورة مصغرة مرسومة والسعر وسعر المتر المربع.',
                ...
                'summary_ar' => 'صفوف العقارات تحتاج إلى صورة، وهذا الجدول يرسمها: مربع بتدرّج CSS عليه نوع العقار، فيحافظ الجدول على إيقاعه البصري دون أي طلب للصور. وسعر المتر المربع هو العمود الذي يقارن عليه الوسطاء.',
                'accent' => '#0f766e',
                ...
                'features_ar' => ['صور مصغرة متدرّجة، بلا ملفات صور', 'حساب سعر المتر المربع لكل صف', 'حالة العرض وعدد الأيام في السوق'],
                'height' => 560,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'مرشحون مع متتبّع مراحل مضمّن وتقييم.',
                ...
                'summary_ar' => 'التوظيف مسار، لذا يُظهر كل صف موقع المرشح فيه كمتتبّع من خمس محطات لا ككلمة. والتقييم من خمسة، والصفوف المرفوضة تبهت دون أن تختفي.',
                'accent' => '#4f46e5',
                ...
                'features_ar' => ['متتبّع من خمس مراحل مرسوم داخل الصف', 'تقييم المقابلة بالنجوم', 'المرشحون المرفوضون باهتون لا مخفيون'],
                'height' => 560,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'مركبات مع المسافة المقطوعة ومستوى الوقود والصيانة القادمة.',
                ...
                'summary_ar' => 'تحمل صفوف الأسطول الأمرين اللذين يُخرجان المركبة من الخدمة: الوقود وموعد الصيانة. كلاهما مقياس، ويتحول مقياس الصيانة إلى الأحمر حين يتجاوز العدّاد الرقم المستحق.',
                'accent' => '#334155',
                ...
                'features_ar' => ['مقياسا الوقود والصيانة لكل مركبة', 'الصيانة المتأخرة مُعلَّمة بالأحمر', 'السائق ورقم اللوحة في كل صف'],
                'height' => 540,
                'max' => 940,
    ...
    private static function setThree(): array
    {
        return [
            [
                ...
                'tagline_ar' => 'قائمة المرضى مع العمر والجناح والطبيب الاستشاري وحالة التنويم.',
                ...
                'summary_ar' => 'قائمة جناح مبنية لتُمسح بسرعة في محطة التمريض: المريض ورقمه الطبي معًا، والسرير الذي يشغله، وشارة حالة تفرّق بين المنوَّم والمُخرَّج والمنتظر. وتأتي علامات الحساسية بجانب الاسم حيث لا يمكن إغفالها.',
                'accent' => '#0891b2',
                ...
                'features_ar' => ['علامة الحساسية بجانب اسم المريض', 'الجناح والسرير في عمود واحد', 'شارات حالة التنويم'],
                'height' => 540,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'قيم التحاليل مقابل النطاقات المرجعية مع علامات الارتفاع والانخفاض.',
                ...
                'summary_ar' => 'لا تُقرأ ورقة النتائج دون نطاقها المرجعي، لذا يحمل كل صف نطاقه، وتُعلَّم القيمة بالارتفاع أو الانخفاض بالنسبة إليه. والعلامة سهم ولون معًا، فتبقى مقروءة عند الطباعة بالأبيض والأسود.',
                'accent' => '#7c3aed',
                ...
                'features_ar' => ['النطاق المرجعي بجانب كل قيمة', 'علامات الارتفاع والانخفاض بالسهم واللون', 'ترويسات مجموعات حسب لوحة التحاليل'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'تبرعات مع الحملة وطريقة الدفع والتكرار والإعفاء الضريبي.',
                ...
                'summary_ar' => 'سجل لجمع التبرعات: التبرعات المتكررة مُعلَّمة ليُفرَّق بين الدخل الشهري والتبرعات لمرة واحدة، ويُحترم المتبرعون المجهولون في العرض، وعمود الحملة هو ما يُجمَّع التقرير حسبه في النهاية.',
                'accent' => '#be123c',
                ...
                'features_ar' => ['التبرعات المتكررة مُعلَّمة بوضوح', 'معالجة المتبرعين المجهولين داخل الصف', 'إجماليات الحملات في التذييل'],
                'height' => 520,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'قائمة الضيوف مع نوع التذكرة وتسجيل حضور بلمسة واحدة.',
                ...
                'summary_ar' => 'قائمة الباب: المس لتسجيل حضور أحدهم، فيتحول الصف إلى الأخضر ويتحرك العدّاد في الأعلى. كل شيء حالة محلية، فيبقى يعمل حين تتعطل شبكة wifi في المكان، وهذه هي الغاية من قائمة الباب أصلًا.',
                'accent' => '#059669',
                ...
                'features_ar' => ['تسجيل حضور بلمسة واحدة مع عدّاد فوري', 'نوع التذكرة والمقعد لكل ضيف', 'يعمل بالكامل دون اتصال'],
                'height' => 560,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'متعلمون مسجّلون مع تقدم الدروس وآخر نشاط.',
                ...
                'summary_ar' => 'تقدم التعلم كحلقة لا كنسبة مئوية: ترى بنظرة من توقف، ويخبرك عمود آخر نشاط إن كان ذلك حديثًا أم منذ ثلاثة أسابيع، وهو الفرق بين تذكير لطيف وطلب استرداد.',
                'accent' => '#4f46e5',
                ...
                'features_ar' => ['حلقة تقدم لكل متعلم', 'الدروس المكتملة مقابل الإجمالي', 'إبراز المتعلمين المتوقفين حسب آخر نشاط'],
                'height' => 540,
                'max' => 900,
                'categories' => ['dashboards'],
            ...
            [
                ...
                'tagline_ar' => 'موردون مع التقييم ومدة التوريد والتسليم في الموعد.',
                ...
                'summary_ar' => 'تقارن المشتريات الموردين بثلاثة أرقام، فجاءت هي الأعمدة: الجودة بالنجوم، ومدة التوريد بالأيام، والتسليم في الموعد كمقياس. وكل ما عدا ذلك نص ثانوي.',
                'accent' => '#0f766e',
                ...
                'features_ar' => ['تقييم بالنجوم ومقياس الالتزام بالموعد جنبًا إلى جنب', 'مدة التوريد مع وصف للتفاوت', 'تعليم المورد المفضّل'],
                'height' => 520,
                'max' => 940,
                'css' => "tbody tr:hover{background:var(--soft)}\n.pref{color:var(--warn)}",
                'body' => self::wrap(
            ...
            [
                ...
                'tagline_ar' => 'اتفاقيات مع عدّ تنازلي حتى الانتهاء ومهلة الإشعار.',
                ...
                'summary_ar' => 'تُدار العقود بالمواعيد النهائية، لذا يُفرز الجدول بها: يتحول عمود العد التنازلي إلى الكهرماني قبل تسعين يومًا وإلى الأحمر داخل مهلة الإشعار، وهي اللحظة التي يبدأ فيها التقاعس بتجديد شيء تلقائيًا.',
                'accent' => '#b45309',
                ...
                'features_ar' => ['عدّ تنازلي للانتهاء بحدود مهلة الإشعار', 'علامة التجديد التلقائي لكل عقد', 'المسؤول والقيمة السنوية'],
                'height' => 540,
                'max' => 960,
            ...
            [
                ...
                'tagline_ar' => 'إنفاق الأدوات مع المقاعد المستخدمة مقابل المدفوعة.',
                ...
                'summary_ar' => 'الجدول الذي يكشف الإنفاق المهدر على البرمجيات: المقاعد المستخدمة مقابل المشتراة، والفجوة محسوبة التكلفة في عمودها الخاص، وموعد التجديد ليُحقَّق التوفير في اللحظة المناسبة فعلًا.',
                'accent' => '#475569',
                ...
                'features_ar' => ['مقياس استخدام المقاعد لكل أداة', 'حساب الإنفاق المهدر لكل صف', 'مواعيد التجديد للتصرف في الفجوة'],
                'height' => 520,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'صفوف مجمّعة حسب المنطقة، لكل مجموعة مجموعها الفرعي.',
                ...
                'summary_ar' => 'جدول تقارير: صفوف تحت ترويسة مجموعة وتُختم بسطر مجموع فرعي، مع إجمالي عام في التذييل. هذا هو الشكل الذي يريده كل تقرير مالي مُصدَّر تقريبًا ولا توفره أي مكتبة مكونات تقريبًا.',
                'accent' => '#1d4ed8',
                ...
                'features_ar' => ['ترويسة مجموعة ومجموع فرعي لكل منطقة', 'إجمالي عام في تذييل الجدول', 'النسبة المئوية من الإجمالي لكل سطر'],
                'height' => 580,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'ترويسات مجموعات تطوي صفوفها.',
                ...
                'summary_ar' => 'حين يحوي الجدول مجموعات أكثر مما تتسع له الشاشة، يتفوق الطي على التمرير. صف الترويسة زر، والسهم يدور، ويبقى عدد الصفوف ظاهرًا أثناء طي المجموعة فلا يضيع شيء بطيّها.',
                'accent' => '#7c3aed',
                ...
                'features_ar' => ['ترويسات مجموعات تُطوى وتُفتح', 'عدد الصفوف يبقى ظاهرًا عند الطي', 'صف الترويسة كاملًا هو أداة التحكم'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'جدول عريض يُمرَّر أفقيًا مع تثبيت التسميات.',
                ...
                'summary_ar' => 'اثنا عشر شهرًا أفقيًا أكثر مما تتسع له أي شاشة، لذا يُثبَّت العمود الأول بالتموضع الثابت ويُمرَّر الباقي تحته. ومن دون ذلك يجبرك الجدول العريض على تذكّر الصف الذي كنت عليه.',
                'accent' => '#0891b2',
                ...
                'features_ar' => ['العمود الأول مثبت بينما يُمرَّر الباقي', 'ترويسة ثابتة إلى جانب العمود الثابت', 'ظل على الحافة المثبتة يوضح الفصل'],
                'height' => 520,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'تحرير في المكان، مع علامة تعديل وشريط حفظ.',
                ...
                'summary_ar' => 'سلوك جداول البيانات دون جدول بيانات: انقر خلية واكتب، فيُعلَّم الصف كمعدَّل حتى يُحفظ. ويعدّ شريط الحفظ التعديلات المعلّقة، فلا يُعتمد شيء خطأً ولا يضيع شيء بصمت.',
                'accent' => '#059669',
                ...
                'features_ar' => ['خلايا تُحرَّر بالنقر عبر contenteditable', 'الصفوف المعدّلة مُعلَّمة حتى الحفظ', 'شريط حفظ يعدّ التعديلات المعلّقة'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'جدول على سطح المكتب، ومجموعة بطاقات على الهاتف.',
                ...
                'summary_ar' => 'لا يصمد جدول البيانات على شاشة 380px، لذا يتوقف هذا عن كونه جدولًا تحت 640px: يصبح كل صف بطاقة، وتكتسب كل خلية تسمية من سمة البيانات الخاصة بها. ترميز واحد، وتخطيطان، وبلا JavaScript.',
                'accent' => '#2563eb',
                ...
                'features_ar' => ['الصفوف تصبح بطاقات تحت 640px', 'تسميات الخلايا من سمات البيانات', 'بلا JavaScript وبلا ترميز مكرر'],
                'height' => 600,
                'max' => 820,
            ...
            [
                ...
                'tagline_ar' => 'صفوف متداخلة مع أسهم توسيع وخطوط إرشاد للإزاحة.',
                ...
                'summary_ar' => 'شجرة مجلدات، أو هيكل تنظيمي، أو دليل حسابات، أي تسلسل هرمي له أعمدة أيضًا. يظهر العمق بالإزاحة وخط إرشاد، وتجمع الصفوف الأم أبناءها، فيخبرك الفرع المطوي بحجمه مع ذلك.',
                'accent' => '#d97706',
                ...
                'features_ar' => ['خطوط إرشاد للإزاحة تُظهر العمق', 'الصفوف الأم تجمع أبناءها', 'الفروع تُطوى بشكل متداخل'],
                'height' => 560,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'الساعات لكل مشروع في كل يوم عمل مع إجماليات يومية وأسبوعية.',
                ...
                'summary_ar' => 'الشبكة التي يُدخل فيها أسبوع العمل فعلًا: المشاريع عموديًا، والأيام أفقيًا، والإجماليات على الحافتين. وتُلوَّن الخلايا التي تتجاوز ثماني ساعات فيُكتشف الإدخال المزدوج العرضي قبل تقديم الأسبوع.',
                'accent' => '#0891b2',
                ...
                'features_ar' => ['إجماليات الصفوف والأعمدة على الحافتين', 'الأيام الطويلة ملوّنة للمراجعة', 'أعمدة عطلة نهاية الأسبوع باهتة بصريًا'],
                'height' => 540,
                'max' => 900,
            ...
            [
                ...
                'tagline_ar' => 'مقارنة منتجات بعلامات دعم ثلاثية الحالة.',
                ...
                'summary_ar' => 'جداول المقارنة تكذب عادةً حين تختزل كل شيء في «نعم» أو «لا». هذا الجدول له ثلاث حالات، كامل وجزئي وغير مدعوم، فيجد «مدعوم مع قيود» مكانًا صادقًا، مع التحفّظ في وصف أسفله.',
                'accent' => '#7c3aed',
                ...
                'features_ar' => ['ثلاث حالات دعم بدل حالتين', 'التحفّظات في وصف أسفل العلامة', 'العمود الفائز ملوّن بالكامل'],
                'height' => 600,
                'max' => 880,
            ...
            [
                ...
                'tagline_ar' => 'إصدارات مع وسوم نوع التغيير وملخص للفروق.',
                ...
                'summary_ar' => 'سجل تغييرات يُمسح بالنظر بدل أن يُقرأ: رقم الإصدار أحادي المسافة، ونوع التغيير شارة باللون المتعارف عليه، وأعداد الأسطر المضافة والمحذوفة حيث يضعها عرض الفروق.',
                'accent' => '#16a34a',
                ...
                'features_ar' => ['وسوم إصدار دلالية مع شارات النوع', 'أعداد الأسطر المضافة والمحذوفة', 'التغييرات الجذرية مُعلَّمة على حدة'],
                'height' => 540,
                'max' => 940,
            ...
            [
                ...
                'tagline_ar' => 'قائمة تجهيز مرتبة حسب الممر مع تأشير الكميات.',
                ...
                'summary_ar' => 'قائمة تجهيز مرتبة كما يمشي العامل: حسب الممر والموقع لا حسب الطلب. يُؤشَّر كل سطر عند التقاطه، ويتبعه العدّاد، وللنقص حالته الخاصة فيُنبَّه المغلِّف قبل إغلاق الصندوق.',
                'accent' => '#c2410c',
                ...
                'features_ar' => ['مرتبة حسب مسار المشي لا حسب الطلب', 'تأشير مع عدّاد تقدم فوري', 'حالة النقص مميزة عن المُلتقَط'],
                'height' => 580,
                'max' => 900,
